...
{
    class Sistema_Empresas : App_Code.Base
    {
        ...
        //Constructores
        public Sistema_Empresas()
        {
            this.declaracion();
        }
        public Sistema_Empresas(int id)
        {
            this.declaracion();
            this.Leer(id);

        }
        public Sistema_Empresas(string codigo)
        {
            this.declaracion();
            this.Leer(codigo);
        ...
        public void Insertar()
        {
            ...
            oComando.Parameters.Add("@conexion", SqlDbType.NVarChar).Value = this.cadena;
        ...
        private void campos(DataSet oDataSet)
        {
            if (oDataSet.Tables["tabla"].Rows.Count != 0)
            {
                ...
                this.cadena = (string)oRow["cadena_conexion"];
        ...
        private void declaracion()
        {
            ...
            this.ins =
                "INSERT INTO " + this.tbl + " (" +
                    "codigo,nombre,cadena_conexion) " +
                "VALUES (" +
                    "@codigo,@nombre,@conexion); " +
