...
namespace panterasoftware.Formularios.Inventario
{
    public partial class frmColores : Form
    {
        ...
        {
            oFuncion.Leer(panterasoftware.Formularios.frmPrincipal.id_grupo_usuario, "0300605");
            if (oFuncion.Err)
            {
        ...
        private void frmColores_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F1:
        ...
        private void frmColores_FormClosed(object sender, FormClosedEventArgs e)
        {
