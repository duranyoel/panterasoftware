...
namespace panterasoftware.Formularios.Inventario
{
    public partial class frmMarcas : Form
    {
        ...
        {
            App_Code.Inventario.Marcas oRegistro = new App_Code.Inventario.Marcas(int.Parse(this.lblFicha.Text));
        ...
        private bool Validar()
        {
            ...
            {
                DataTable oTabla = new App_Code.Inventario.Marcas().Buscar(
                1,
                "id",
