...
namespace panterasoftware.Formularios.Inventario
{
    public partial class frmTallas : Form
    {
        ...
        {
            App_Code.Inventario.Tallas oRegistro = new App_Code.Inventario.Tallas(int.Parse(this.lblFicha.Text));
            ...
            try
            {
                if (!Validar())
                {
                    if (oRegistro.Err)
                    {
                        oFuncion.Leer(panterasoftware.Formularios.frmPrincipal.id_grupo_usuario, "0300702");
                        if (oFuncion.Err)
                        {
                    ...
                    {
                        oFuncion.Leer(panterasoftware.Formularios.frmPrincipal.id_grupo_usuario, "0300703");
                        if (oFuncion.Err)
                        {
        ...
        {
            App_Code.Inventario.Tallas oRegistro = new App_Code.Inventario.Tallas(id);
            ...
            oFuncion.Leer(panterasoftware.Formularios.frmPrincipal.id_grupo_usuario, "0300704");
            if (!oFuncion.Err)
            {
        ...
        private void Borrar()
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        App_Code.Inventario.Tallas oRegistro = new App_Code.Inventario.Tallas(int.Parse(this.lblFicha.Text.ToString()));
        ...
        {
            oFuncion.Leer(panterasoftware.Formularios.frmPrincipal.id_grupo_usuario, "0300705");
            if (oFuncion.Err)
            {
        ...
        private bool Validar()
        {
            ...
            {
                DataTable oTabla = new App_Code.Inventario.Tallas().Buscar(
                1,
                "id",
        ...
        private void frmTallas_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F1:
        ...
        private void frmTallas_FormClosed(object sender, FormClosedEventArgs e)
        {
