...
namespace panterasoftware.Empresa
{
    public partial class frmAgencias : Form
    {
        ...
        private void frmAgencias_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        {
            App_Code.Empresa.Agencias oRegistro = new App_Code.Empresa.Agencias(int.Parse(this.lblFicha.Text));
        ...
        {
            App_Code.Empresa.Agencias oRegistro = new App_Code.Empresa.Agencias(id);
        ...
        private void Borrar()
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        App_Code.Empresa.Agencias oRegistro = new App_Code.Empresa.Agencias(int.Parse(this.lblFicha.Text.ToString()));
                        oRegistro.Eliminar();
                        this.Nuevo();
                        MessageBox.Show(oRegistro.Msg, "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
        ...
        private void frmAgencias_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F1:
