...
namespace panterasoftware.Sistema
{
    public partial class frmModulos : Form
    {
        ...
        {
            App_Code.Sistema.Sistema_Modulos oRegistro = new App_Code.Sistema.Sistema_Modulos(int.Parse(this.lblFicha.Text));
            ...
            try
            {
                if (!Validar())
                {
                    if (oRegistro.Err)
                    {
                        oFuncion.Leer(panterasoftware.Formularios.frmPrincipal.id_grupo_usuario, "1200202");
                        if (oFuncion.Err)
                        {
                    ...
                    {
                        oFuncion.Leer(panterasoftware.Formularios.frmPrincipal.id_grupo_usuario, "1200203");
                        if (oFuncion.Err)
                        {
        ...
        {
            App_Code.Sistema.Sistema_Modulos oRegistro = new App_Code.Sistema.Sistema_Modulos(id);
            ...
            oFuncion.Leer(panterasoftware.Formularios.frmPrincipal.id_grupo_usuario, "1200204");
            if (!oFuncion.Err)
            {
        ...
        private void Borrar()
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        App_Code.Sistema.Sistema_Modulos oRegistro = new App_Code.Sistema.Sistema_Modulos(int.Parse(this.lblFicha.Text.ToString()));
        ...
        {
            oFuncion.Leer(panterasoftware.Formularios.frmPrincipal.id_grupo_usuario, "1200205");
            if (oFuncion.Err)
            {
        ...
        private void frmModulos_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F1:
        ...
        private void frmModulos_FormClosed(object sender, FormClosedEventArgs e)
        {
